...
game_over_music_path='assets/game_Over2.mp3' 
...
def draw_last_screen(girl,player,lemons_sprite,initial_shoot_interval,score):
        ...
        WIN.blit(score_text, ((WIDTH//2)-70, 180))
...
jumping_music_path = "assets/girl_jumping.mp3" 
bullet_music_path='assets/Throwing-sound-effect.mp3'

bg_music_path='assets/bg_music.mp3' 

bullet_music = pygame.mixer.Sound(bullet_music_path)
jump_music = pygame.mixer.Sound(jumping_music_path)
...
volume_level = initial_volume * 0.05
bg_music.set_volume(volume_level)
bg_music.play()
...
while run:
    ...
    if game_state == "game_over":
        ...
        score,last_shoot_time,shoot_interval,game_state=draw_last_screen(girl,player,lemons_sprite,initial_shoot_interval,final_score)
